...
1. Clone the repository:
   git clone https://github.com/AlexMoskalyk/foodies-front.git
...
4. Run project:
   npm start
   ##Usage
   After starting the project, you can view the homepage in your browser at http://localhost:5173/foodies-front. The interface allows users to browse existing recipes, search by keywords, and add new recipes through special forms.
   ##Project structure
